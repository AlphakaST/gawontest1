...
# ── 3‑1. 서술형 문제 1 표시 ──
QUESTION_1 = """
물질을 구성하는 입자들의 운동 에너지와 온도의 관계를 서술하세요.
"""  # ← 교사가 원하는 서술형 문제로 변경
...
# ── 3‑2. 서술형 문제 2 표시 ──
QUESTION_2 = """
기체의 압력과 부피가 반비례한다는 보일의 법칙을 일상 사례와 함께 설명하세요.
"""
...
# ── 3‑3. 서술형 문제 3 표시 ──
QUESTION_3 = """
열에너지 이동 3가지 방식(전도·대류·복사)을 예시를 들어 비교하세요.
"""
...
# ── 1. 문항별 채점 기준 (교사가 수정) ──
GRADING_GUIDELINES = {
    1: "입자 운동 에너지는 온도와 비례 관계임을 언급하고, 입자 충돌·속도 증가 예를 기술한다.",
    2: "용해는 고체가 액체에 균일하게 섞이는 과정, 용액은 그 결과물임을 구분하여 설명한다.",
    3: "질량 보존 법칙을 정의하고, 화학 반응 전후의 총 질량이 같음을 예로 든다."
}
